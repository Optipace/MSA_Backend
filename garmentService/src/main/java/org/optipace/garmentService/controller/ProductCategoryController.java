...
public class ProductCategoryController {
    ...
    public ResponseEntity<SingleResponse<PageResponse<ListOfProductCategoryResponse>>> getAllProductCategories(
        ...
        return ResponseEntity.ok(
                productCategoryService.getAllProductCategories(pageable)
        );
    }
    ...
    @PreAuthorize("hasAuthority('SUPER_ADMIN')")
    public ResponseEntity<SingleResponse<?>> updateProductCategory(
            @PathVariable Long productCategoryId,
    ...
    @PreAuthorize("hasAuthority('SUPER_ADMIN')")
    public ResponseEntity<SingleResponse<?>> deleteProductCategory(
            @PathVariable Long productCategoryId,
            @RequestHeader("X-User-Id") String adminId) {

        return ResponseEntity.ok(
                productCategoryService.deleteProductCategoryById(
                        productCategoryId,
                        adminId
                )
        );
